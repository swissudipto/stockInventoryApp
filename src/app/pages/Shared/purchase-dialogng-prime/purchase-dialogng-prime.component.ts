...
@Component({
  selector: 'app-purchase-dialogng-prime',
  templateUrl: './purchase-dialogng-prime.component.html',
  styleUrls: ['./purchase-dialogng-prime.component.css']
})
export class PurchaseDialogngPrimeComponent {
